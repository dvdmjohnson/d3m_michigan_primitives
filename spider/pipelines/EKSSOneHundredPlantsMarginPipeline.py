...
class EKSSOneHundredPlantsMarginPipeline(BasePipeline):
    ...
    def _gen_pipeline():
        ...
        # NDARRAY -> Cluster
        step_5 = meta_pipeline.PrimitiveStep(primitive_description=EKSS.metadata.query())
        step_5.add_argument(name='inputs', argument_type=ArgumentType.CONTAINER, data_reference='steps.4.produce')
        step_5.add_hyperparameter(name='n_clusters', argument_type=ArgumentType.VALUE, data=200)
