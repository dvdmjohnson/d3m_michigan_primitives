...
from spider.unsupervised_learning.grouse import GROUSE
...
class GROUSEAutoMPGPipeline(BasePipeline):
    ...
    def _gen_pipeline(self):
        ...
        #Run GROUSE
        step_5 = meta_pipeline.PrimitiveStep(primitive_description = GROUSE.metadata.query())
        step_5.add_argument(
            name = 'inputs',
            argument_type = ArgumentType.CONTAINER,
        ...
        #Linear Regression on low-rank data
        ...
        # finally generate a properly-formatted output dataframe from the dataframed prediction outputs using the input dataframe as a reference
