...
class SSCOMPOneHundredPlantsMarginPipeline(BasePipeline):
    ...
    primitive_entry_point = 'd3m.primitives.clustering.ssc_omp.Umich'
    ...
    def _gen_pipeline():
        ...
        # NDARRAY -> Cluster
        step_5 = meta_pipeline.PrimitiveStep(primitive_description=SSC_OMP.metadata.query())
        step_5.add_argument(name='inputs', argument_type=ArgumentType.CONTAINER, data_reference='steps.4.produce')
        step_5.add_hyperparameter(name='n_clusters', argument_type=ArgumentType.VALUE, data=100)
        step_5.add_hyperparameter(name='sparsity_level', argument_type=ArgumentType.VALUE, data=5)
