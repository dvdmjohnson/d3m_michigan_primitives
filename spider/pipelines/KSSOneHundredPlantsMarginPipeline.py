...
class KSSOneHundredPlantsMarginPipeline(BasePipeline):
    ...
    primitive_entry_point = 'd3m.primitives.clustering.kss.Umich'
    ...
    def _gen_pipeline():
        ...
        # NDARRAY -> Cluster
        step_5 = meta_pipeline.PrimitiveStep(primitive_description=KSS.metadata.query())
        step_5.add_argument(name='inputs', argument_type=ArgumentType.CONTAINER, data_reference='steps.4.produce')
        step_5.add_hyperparameter(name='n_clusters', argument_type=ArgumentType.VALUE, data=5000)
        step_5.add_hyperparameter(name='dim_subspaces', argument_type=ArgumentType.VALUE, data=1)
