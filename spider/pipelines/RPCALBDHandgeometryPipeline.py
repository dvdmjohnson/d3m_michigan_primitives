...
from spider.dimensionality_reduction.rpca_lbd import RPCA_LBD
...
class RPCALBDHandgeometryPipeline(BasePipeline):
    def __init__(self):
        super().__init__()
    ...
    def _gen_pipeline(self):
        ...
        step_7 = meta_pipeline.PrimitiveStep(primitive_description=RPCA_LBD.metadata.query())
        step_7.add_argument(
            name='inputs',
            argument_type=ArgumentType.CONTAINER,
